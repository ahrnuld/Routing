...
$this->connection->query("CREATE TABLE `article` (
    id int NOT NULL,
...
// $this->connection->query("INSERT INTO `article` (id, title, content, author, posted_at) VALUES
...
// $this->connection->query("ALTER TABLE `article`
//   ADD PRIMARY KEY (id);");
